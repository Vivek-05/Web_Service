...
public class FireBaseServiceDao {
	...
	public String executeUpdateStatus(String status) {
		...
		try {
			...
			info.put("title", "OrderStatus"); // Notification title
			info.put("body", status); // Notification body
